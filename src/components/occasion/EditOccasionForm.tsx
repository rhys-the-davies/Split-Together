...
export function EditOccasionForm({ action, defaultValues }: EditOccasionFormProps) {
  const [state, formAction, isPending] = useActionState(action, null);
  const [recurrence, setRecurrence] = useState<"one_off" | "annual">(defaultValues.recurrence);
